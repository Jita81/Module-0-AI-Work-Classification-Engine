"""
Type definitions for NotificationHub MCP Server

This module contains all type definitions, data classes, and schemas
used by the notification-hub MCP server for communications domain.
"""
...
class NotificationHubConfig:
    """Configuration for NotificationHub MCP Server"""
    
    # AI_TODO: Define configuration parameters specific to communications
    # Examples:
    ...
    server_name: str = "notification-hub-mcp-server"
