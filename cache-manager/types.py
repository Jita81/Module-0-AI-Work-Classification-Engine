"""
Type definitions for CacheManager MCP Server

This module contains all type definitions, data classes, and schemas
used by the cache-manager MCP server for infrastructure domain.
"""
...
class CacheManagerConfig:
    """Configuration for CacheManager MCP Server"""
    
    # AI_TODO: Define configuration parameters specific to infrastructure
    # Examples:
    ...
    server_name: str = "cache-manager-mcp-server"
