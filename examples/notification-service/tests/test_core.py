...
from ..core import NotificationServiceModule, BusinessRuleViolation
...
class TestNotificationServiceModule:
    """Test suite for NotificationServiceModule"""
    ...
    def test_health_status(self, module):
        ...
        assert status["module_name"] == "notification-service"
        assert status["type"] == "SUPPORTING"
    ...
    def test_primary_operation_not_initialized(self, module):
        ...
        input_data = NotificationServiceInput(operation_type="test")
...
class TestIntegration:
    """Integration tests for NotificationServiceModule"""
