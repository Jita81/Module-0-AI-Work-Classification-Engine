...
from ..core import CacheManagerModule, BusinessRuleViolation
...
class TestCacheManagerModule:
    """Test suite for CacheManagerModule"""
    ...
    def test_health_status(self, module):
        ...
        assert status["module_name"] == "cache-manager"
        assert status["type"] == "TECHNICAL"
    ...
    def test_primary_operation_not_initialized(self, module):
        ...
        input_data = CacheManagerInput(operation_type="test")
...
class TestIntegration:
    """Integration tests for CacheManagerModule"""
