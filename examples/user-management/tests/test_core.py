...
from ..core import UserManagementModule, BusinessRuleViolation
...
class TestUserManagementModule:
    ...
    def test_health_status(self, module):
        ...
        assert status["module_name"] == "user-management"
    ...
    def test_primary_operation_not_initialized(self, module):
        ...
        input_data = UserManagementInput(operation_type="test")
