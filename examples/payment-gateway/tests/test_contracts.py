"""
Contract compliance tests for payment-gateway
...
from ..types import PaymentGatewayConfig, OperationResult


class TestContractCompliance:
    """Test that PaymentGatewayModule complies with its interface contract"""
    
    @pytest.fixture
    def config(self):
        """Create test configuration"""
        
        return PaymentGatewayConfig(domain="payments")
    ...
    def test_implements_interface(self, module):
        ...
        assert isinstance(module, PaymentGatewayInterface)
    ...
    def test_execute_primary_operation_signature(self, module):
        ...
        module.initialize()
        input_data = PaymentGatewayInput()
