"""
Type definitions for PaymentGateway MCP Server

This module contains all type definitions, data classes, and schemas
used by the payment-gateway MCP server for payments domain.
"""
...
class PaymentGatewayConfig:
    """Configuration for PaymentGateway MCP Server"""
    ...
    server_name: str = "payment-gateway-mcp-server"
    domain: str = "payments"
    log_level: str = "INFO"
