#!/usr/bin/env python3
"""
MCP Server Runner for payment-gateway

This script starts the PaymentGateway MCP server with proper configuration
...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler(f'payment-gateway_mcp.log')
        ]
    )
...
async def run_mcp_server():
    ...
    try:
        ...
        logger.info(f"Starting PaymentGateway MCP Server...")
