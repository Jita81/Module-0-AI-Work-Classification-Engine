"""
Interface definition for PaymentGateway MCP Server
...
class PaymentGatewayInterface(ABC):
    """
    Interface contract for PaymentGateway MCP Server
    
    All INTEGRATION modules in the payments domain must implement
    ...
    @abstractmethod
    async def execute_primary_operation(self, data: Dict[str, Any]) -> PaymentGatewayResult:
