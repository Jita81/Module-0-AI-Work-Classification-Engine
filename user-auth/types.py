"""
Type definitions for UserAuth MCP Server

This module contains all type definitions, data classes, and schemas
used by the user-auth MCP server for authentication domain.
"""
...
class UserAuthConfig:
    """Configuration for UserAuth MCP Server"""
    
    # AI_TODO: Define configuration parameters specific to authentication
    # Examples:
    ...
    server_name: str = "user-auth-mcp-server"
